    ...
    <div class="row">
      <div class="col-sm-12 col-md-9 col-md-offset-2">
        ...
        <div class="page-ads box">
          <form id="form-ad" action="{{route('add_job')}}"  method="post">
            @csrf
            ...
            <div class="form-group is-empty">
              ...
              <option name="category" value="{{$item->id}}">{{$item->categoryname}}</option>
              @endforeach
            </select>
            ...
            <div class="form-group is-empty">
              ...
              <div class="form-group is-empty">
                ...
                <input type="text" name="salary_offer" class="form-control">
              </div>
              <div class="form-group is-empty">
