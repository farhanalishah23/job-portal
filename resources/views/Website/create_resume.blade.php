          ...
          <div class="row">         
            <div class="col-md-12">
              <div class="breadcrumb-wrapper">
                <h2 class="product-title">Update User Profile</h2>
                <ol class="breadcrumb">
                  <li><a href="{{route('/')}}"><i class="ti-home"></i> Home</a></li>
                  <li class="current">Update User profile</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-9 col-md-offset-2">
            <div class="page-ads box">
              <form class="form-ad" method="post" action="{{route('update_user_profile')}}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{auth()->id()}}">
                <div class="divider"><h3>Update User Profile</h3></div>
...
<img src="{{ 
    $imageExists
        ...
        : 'https://img.freepik.com/premium-vector/silver-membership-icon-default-avatar-profile-icon-membership-icon-social-media-user-image-vector-illustration_561158-4195.jpg?semt=ais_hybrid&w=740' 
                ...
                <div class="form-group is-empty">
                  <label class="control-label" for="textarea">Profile Title</label>
                  <input type="text" name="profile_title" value="{{auth()->user()->profile_title ?? null}}" class="form-control" placeholder="Enter your profile title">
                ...
                <span class="material-input"></span></div> 
                <div class="form-group is-empty">
                  <label class="control-label" for="textarea">Past Experience</label>
                  <input type="text" class="form-control" name="past_experience" value="{{auth()->user()->past_experience ?? null}}" placeholder="Enter your past experience">
                <span class="material-input"></span></div>  
                <div class="form-group is-empty">
                  <label class="control-label" for="textarea">Skills</label>
                  <input type="text" name="skill_one" value="{{auth()->user()->skill_1 ?? null}}" class="form-control" placeholder="Enter your skill">
                  <input type="text" name="skill_two" value="{{auth()->user()->skill_2 ?? null}}" class="form-control" placeholder="Enter your skill">
                  <input type="text" name="skill_three" value="{{auth()->user()->skill_3 ?? null}}" class="form-control" placeholder="Enter your skill">
                <span class="material-input"></span></div>  
                <div class="form-group is-empty">
                  <label class="control-label" for="textarea">Cover letter</label>
                  <textarea type="text" name="cover_letter" class="form-control" placeholder="Enter Cover Letter">{{auth()->user()->cover_letter ?? null}}</textarea>
                <span class="material-input"></span></div> 
    ...
    $(document).ready(function () {
        ...
        $(".form-ad").validate({
            ...
            messages: {
                ...
                profile_title: {
                    required: "Please enter your profile title.",
                    minlength: "Your profile title must be at least 3 characters long.",
                },
                name: {
                ...
                phone_no: {
                    ...
                    maxlength: "Your phone number must be 11 digits long.",
                ...
                past_experience: {
                    ...
                    minlength: "Your past experience must be at least 5 characters long.",
                },
                skill_one: {
                    required: "Please enter your skill.",
                    minlength: "Your skill must be at least 3 characters long.",
                },
                skill_two: {
                    required: "Please enter your skill.",
                    minlength: "Your skill must be at least 3 characters long.",
                ...
                cover_letter: {
                    ...
                    minlength: "Your cover letter must be at least 10 characters long.",
                },
            },
